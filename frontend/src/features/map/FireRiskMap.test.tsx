  ...
  it('auto-focuses spread once per playback so manual zoom is not overridden', () => {
    const fireSpread = {
      ...
      data: {
        ...
        snapshots: [
          { hour: 0, radius_km_min: 0, radius_km_mean: 0, radius_km_max: 0, area_km2: 0, polygon: [] },
          {
            hour: 1,
            radius_km_min: 0.1,
            radius_km_mean: 0.2,
            radius_km_max: 0.3,
            area_km2: 0.1,
            polygon: [{ lat: 39.7, lon: -6.2 }, { lat: 39.71, lon: -6.19 }, { lat: 39.69, lon: -6.18 }],
          },
          {
            hour: 2,
            radius_km_min: 0.2,
            ...
            radius_km_max: 0.4,
            area_km2: 0.2,
            polygon: [{ lat: 39.7, lon: -6.2 }, { lat: 39.72, lon: -6.18 }, { lat: 39.68, lon: -6.17 }],
          },
        ],
      },
    };
