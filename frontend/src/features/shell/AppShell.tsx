...
export function AppShell({ dashboard, liveFires, fireSpread, reverseLocation, simulationReverseLocation, chat, fireReport, simulation, map }: {
  ...
  const rawSelectedFire = liveFires.state.data?.detections.find((fire) => fire.id === liveFires.selectedFireId) ?? null;
