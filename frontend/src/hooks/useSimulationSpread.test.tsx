...
const response: SpreadResponse = {
  ...
  snapshots: [{
    ...
    rings: [], intensity_kw_m_min: 0, intensity_kw_m_mean: 0, intensity_kw_m_max: 0,
  }],
...
describe('useSimulationSpread', () => {
  ...
  it('fetches a spread simulation for a clicked point', async () => {
    ...
    expect(apiClient.spread).toHaveBeenCalledWith({ lat: 41.2, lon: -5.1 }, expect.any(AbortSignal));
